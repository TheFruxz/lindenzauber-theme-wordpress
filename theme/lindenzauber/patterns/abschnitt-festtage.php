<?php
/**
 * Title: Abschnitt: Die beiden Festtage
 * Slug: lindenzauber/abschnitt-festtage
 * Categories: lindenzauber
 * Description: Zwei gleichwertige Karten für Samstag und Sonntag. Die goldene Kante oben und die gleiche Form zeigen, dass beide Tage zusammengehören; nur das Zeichen unterscheidet sie.
 * Keywords: samstag, sonntag, tage, karten, termine
 * Inserter: yes
 *
...
<!-- wp:paragraph -->
<p>Hier stehen zwei bis drei Sätze zum Abend.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Hier stehen zwei bis drei Sätze zum Nachmittag.</p>
<!-- /wp:paragraph -->
